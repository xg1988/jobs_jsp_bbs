...
<body>
	...
	<br />
	<form
		action="<%=request.getContextPath()%>/bootstrap/nologin/updateProcess.jsp?bbs_id=<%=bbs_id%>"
		method="post">
		<table>
			<tr>
				<td>이름 :</td>
		...
		<input type="submit" value="수정"><input type="button"
			value="취소"
			onclick="location.href='<%=request.getContextPath()%>/bootstrap/nologin/list.jsp'">
	</form>
</body>
</html>